...
public class Stars : MonoBehaviour
{
    ...
    public IEnumerator GetStars(int a)
    {
        ...
        for (int i = 0; i < a; i++)
        {
            ...
            Tween m = obj.transform.DOMove(positions[i].position, 0.5f, false).Play();
            Tween r = obj.transform.DOLocalRotate(new Vector3(0, 0, 360), 0.5f, RotateMode.FastBeyond360).Play();
